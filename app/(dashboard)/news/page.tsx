...
import { ImageWithFallback } from "@/frontend/image-with-fallback";
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent">FinSight AI</span>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {paginatedArticles.map((article, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className={`absolute -inset-0.5 bg-gradient-to-r ${sentimentResult.label === "Positive" ? "from-green-500 to-emerald-600" :
                          ...
                          <Card className="relative h-full p-4 bg-card/60 backdrop-blur-md hover:bg-card/80 transition-all duration-300 border border-primary/10 hover:border-teal-500/30 shadow-lg hover:shadow-teal-500/10">
                            {article.urlToImage ? (
                            ...
                            <div className="flex flex-col h-full">
                              <div className="flex justify-between items-start mb-2">
                                ...
                                <span
                                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${sentimentResult.label === "Positive" ? "bg-green-100 text-green-800" :
          ...
          <div className="flex justify-center mt-4 mb-2 gap-2 relative z-20">
            ...
            <div className="flex items-center gap-1 relative z-20">
              ...
              <Button
                ...
                className={`w-10 h-10 relative z-20 ${currentPage === 1
                  ? "bg-gradient-to-r from-primary to-primary/80 hover:opacity-90"
                  : "border-primary/10 hover:bg-primary/10"
                  }`}
              >
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1)
                ...
                .map((page) => (
                  <Button
                    ...
                    className={`w-10 h-10 relative z-20 ${currentPage === page
                      ? "bg-gradient-to-r from-primary to-primary/80 hover:opacity-90"
                      : "border-primary/10 hover:bg-primary/10"
                      }`}
                  >
              ...
              {totalPages > 1 && (
                <Button
                  ...
                  className={`w-10 h-10 relative z-20 ${currentPage === totalPages
                    ? "bg-gradient-to-r from-primary to-primary/80 hover:opacity-90"
                    : "border-primary/10 hover:bg-primary/10"
                    }`}
                >
